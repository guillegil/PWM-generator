...
HD_PWD='/home/guille/Documentos/VivadoProj/pwm_gen/pwm_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log square_wave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source square_wave.tcl
