...
entity clock is
  ...
  attribute CORE_GENERATION_INFO of clock : entity is "clock,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=clock,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_board_cnt=2,da_clkrst_cnt=1,synth_mode=Global}";
...
architecture STRUCTURE of clock is
  ...
  component clock_xadc_wiz_0_0 is
  port (
  ...
  end component clock_xadc_wiz_0_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk_125MHz : signal is "XIL_INTERFACENAME CLK.CLK_125MHZ, CLK_DOMAIN clock_clk_100MHz, FREQ_HZ 125000000, PHASE 0.000";
  attribute X_INTERFACE_INFO of clk_out1_0 : signal is "xilinx.com:signal:clock:1.0 CLK.CLK_OUT1_0 CLK";
  attribute X_INTERFACE_PARAMETER of clk_out1_0 : signal is "XIL_INTERFACENAME CLK.CLK_OUT1_0, CLK_DOMAIN /clk_wiz_0_clk_out1, FREQ_HZ 5000000, PHASE 0.0";
...
xadc_wiz_0: component clock_xadc_wiz_0_0
     port map (
